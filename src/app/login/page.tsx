...
setError("Email or Password is wrong!")
  ...
  return (
    <div className='w-screen h-screen flex justify-between px-4 items-center'>
     <img src="https://img.freepik.com/free-vector/tablet-login-concept-illustration_114360-7893.jpg?t=st=1715689820~exp=1715693420~hmac=f97d47356607d1af5650469a5ca1fc30a0de97feba4bb596e0bc088699fa0e9a&w=740" alt='Login Here' className='w-[40%]'/>
     <div className='w-[60%]  h-full flex items-center justify-center'>
     <form className='w-[30vw] h-[75vh] rounded-md border border-gray-400 flex items-center justify-start flex-col py-9 gap-8 relative' onSubmit={(e)=>e.preventDefault()} >
